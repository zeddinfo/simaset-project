    ...
    public function create(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            try{
                ...
                $model->hadap = $request->menghadap_ke;
                ...
                if($request->perizinan){
                    ...
                    foreach($request->perizinan as $r){
                        ...
                        $perizinan->tgl_izin = date('Y-m-d', strtotime($request->tgl_izin));
                ...
                $penyewa->selesai_sewa = Carbon::create($request->tgl_sewa)->addYears($request->lama_sewa);
                $penyewa->harga_jual = $request->harga_jual;
