...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="text" class="form-control bg-white" id="inputPassword3"
            placeholder="Password" readonly
            value="{{isset($model) && $model->perizinan[1]->perizinan ?  $model->perizinan[1]->perizinan. ' NOMOR '.$model->perizinan[1]->nomor : '-NOMOR'}}">
    </div>
</div>
<div class="form-group row">
    <label for="inputPassword3" class="col-sm-3 col-form-label"><b>DITERBIT</b>
    </label>
    <div class="col-sm-9">
        <input type="text" class="form-control bg-white" id="inputPassword3"
            placeholder="Password" readonly
            value="{{isset($model) && $model->perizinan[1]->tgl_izin ? $model->perizinan[1]->tgl_izin : '00 - 00 - 0000'}}">
    </div>
</div>