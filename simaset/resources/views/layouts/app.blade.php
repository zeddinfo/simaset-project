        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Master Kategori</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{url('/md/kategori')}}">List Kategori</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-th"></i> <span>Master Asset</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="{{url('/md/asset/index')}}">List Asset</a></li>
                </ul>
              </li>
